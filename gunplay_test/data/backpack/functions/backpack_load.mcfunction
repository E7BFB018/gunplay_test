...
execute if score @s backpack_extract matches 130..139 run item replace entity @s container.0 with tacz:modern_kinetic_gun{GunCurrentAmmoCount:40,GunFireMode:"SEMI",GunId:"fight:lw3",HasBulletInBarrel:1b,DummyAmmo:30} 1
execute if score @s backpack_extract matches 140..149 run item replace entity @s container.0 with tacz:modern_kinetic_gun{GunCurrentAmmoCount:40,GunFireMode:"AUTO",GunId:"fight:vector45_lbs",HasBulletInBarrel:1b,DummyAmmo:170} 1
execute if score @s backpack_extract matches 150..159 run item replace entity @s container.0 with tacz:modern_kinetic_gun{GunCurrentAmmoCount:40,GunFireMode:"AUTO",GunId:"fight:scar_dm",HasBulletInBarrel:1b,DummyAmmo:150} 1
