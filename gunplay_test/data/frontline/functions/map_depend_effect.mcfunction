...
execute if score gamemap gamedata matches 4 run effect give @s resistance 3 5 true
execute if score gamemap gamedata matches 4 run tag @s add mark_remove_3s
